...
The reference art for the tio.ist Pixel World:

- `inside2.jpeg`: pixel-art illustration of the actual space, seen from the
  entrance. Source for the layout, materials and palette.
- `inside-desk-wall.jpeg`: the desk row, the wall shelf with plants, and the
  mezzanine.
- `inside-dining.jpeg`: the dining room behind the curtain.
